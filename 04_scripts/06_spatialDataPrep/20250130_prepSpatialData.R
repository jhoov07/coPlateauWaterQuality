...
#[13] "prism30yr_500m.tif"  "Top5_Ca.tif"         "Top5_S_500m.tif"    "Top5_Be.tif"    "Top5_Ni.tif"
...
Top5_Ni<-rast(paste(wd,"/Top5_Ni.tif", sep=""))
Top5_Be<-rast(paste(wd,"/Top5_Be.tif", sep=""))
...
C_Tot_K_fs<-resample(C_Tot_K_fs, Fe, method = "bilinear")
...
Top5_Be<-resample(Top5_Be, Fe, method = "bilinear")
Top5_Ni<-resample(Top5_Ni, Fe, method = "bilinear")
...
C_Tot_K_fs<-crop(C_Tot_K_fs, Fe, mask = TRUE)
...
Top5_Be<-crop(Top5_Be, Fe, mask = TRUE)
Top5_Ni<-crop(Top5_Ni, Fe, mask = TRUE)
...
writeRaster(C_Tot_K_fs, paste(d, "C_Tot_K_fs.tif", sep=""))
writeRaster(Top5_Be, paste(d, "Top5_Be.tif", sep=""))
writeRaster(Top5_Ni, paste(d, "Top5_Ni.tif", sep=""))
