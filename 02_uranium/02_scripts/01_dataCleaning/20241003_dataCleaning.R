...
#Load data
#data <- read.csv("./02_Data/Raw_Data/Nure7_Data_ExportTable.csv")
data2 <- read.csv("./02_Data/Raw_Data/wqpData_cleaned_20240808.csv", na.strings = "NULL")
data3 <- read.csv("./02_Data/Raw_Data/nnwells3_ExportTable.csv")
